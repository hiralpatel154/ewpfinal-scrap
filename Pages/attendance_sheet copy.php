...
<head>
    ...
    <style>
        ...
        #att-data th,#att-two-data th,#att-three-data th,
        #att-all-data th {
            white-space: nowrap !important;
        }

        #att-data tr td,#att-two-data tr td,#att-three-data tr td,
        #att-all-data tr td {
            text-align: center;
        }
        ...
        @media only screen and (max-width:3470px) {
            #att-data, #att-all-two-data, #att-all-three-data, #att-all-data,#att-two-data,#att-three-data {
                display: block;
                overflow-x: auto;
            }
        }
            ...
            <div class="divCss">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-2 col-sm-12">
                        <button type="button" value="" name="submit" class="btn common-btn float-end m-3"
